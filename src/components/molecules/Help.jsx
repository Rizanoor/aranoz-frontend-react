                    ...
                    <div className="row justify-content-between">
                        <div className="col-lg-7 mb-5 mb-lg-0">
                            <div className="imgs-grid">
                                <div className="grid grid-1"><img src={img1} alt="Untree.co" /></div>
                                <div className="grid grid-2"><img src={img2} alt="Untree.co" /></div>
                                <div className="grid grid-3"><img src={img3} alt="Untree.co" /></div>
                            </div>
                        </div>
